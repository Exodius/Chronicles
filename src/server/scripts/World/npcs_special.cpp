...
#define GOSSIP_CHOOSE_FACTION     "I would like to choose my faction - After choosing your faction speak to this NPC again to be teleported to the mall."
#define GOSSIP_TP_STORMIND        "I would like to go to the Elixium-WoW Mall"
#define GOSSIP_TP_ORGRI           "I would like to go to the Elixium-WoW Mall"
    ...
    public:
        ...
        bool OnGossipSelect(Player* player, Creature* /*creature*/, uint32 /*sender*/, uint32 action)
        {
            if (action == GOSSIP_ACTION_INFO_DEF + 1)
                ...
                player->TeleportTo(1, 3300.33f, -4482.37f, 268.169f, 4.68675f);
        ...
        struct npc_wild_impAI : public ScriptedAI
        {
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                if ((me->getVictim() || me->GetOwner()->getAttackerForHelper()))
                {
                    ...
                    if (me->GetOwner()->HasAura(122351) && me->GetOwner()->getLevel() >= 69)
                        if (roll_chance_i(8))
